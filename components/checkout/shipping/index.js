...
export default function Shipping({ user, addresses, setAddresses, profile }) {
  ...
  const saveShippingHandler = async () => {
    ...
    setShowMessage(window.location.reload(true));
  };
      ...
      <div className={styles.addresses}>
        {addresses && addresses.map((address)  => (
          <div style={{ position: "relative" }}>
            ...
            >
              {/* <div>{ showDeleteMessage && <div>Address Successfull Deleted!</div>}</div> */}
        ...
        >
          {(formik) => (
            <Form>
              ...
              {/* {showMessage && <div className={styles.save_address} >Address Successfull Saved!
              Refresh the browser to see your shipping infos.
              </div>} */}
            </Form>
          )}
        </Formik>
